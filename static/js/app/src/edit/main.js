            ...
            var e = {
                ...
                n = function() {
                    var e = '<div class="cell_null">No outline for the active view</div>',
                        t = Editor.current();
                    if (!t || t.kod === void 0) return $(".function_list_box").html(e),
                        void 0;
                    var n = function(e) {
                        ...
                        s = t.kod.mode,
                        o = a(t.getValue(), s);
                    if (o === void 0 || 0 == o.length) return $(".function_list_box").html(e),
                        void 0;
                ...
                s = function() {
                    $(".function_list_box .list_row").die("mouseenter").live("mouseenter",
                        function() {
                        ...
                        function() {
                            $(".function_list_box .list_row").removeClass("row_select"),
            ...
            var e = function() {
                ...
                i = function() {
                    var e,
                        ...
                        d = 0,
                        p = 0;
                    $(".edit_tab .tab").die("mousedown").live("mousedown",
                        function(t) {
                    ...
                    var u = function(i) {
                            s = !0,
                                ...
                                a = e.clone().addClass("draggable-dragging").prependTo("body"),
                                c = $sizeInt(t.css("margin-right")),
                                d = $tab_parent.width(),
                                p = $tab_parent.get(0).getBoundingClientRect().left,
                                p += $(window).scrollLeft(),
                                r = e.get(0).getBoundingClientRect().left,
                                l = $sizeInt(t.css("width"));
                        ...
                        f = function(a, n) {
                            if (!e.is(":animated") || i != a) {
                                ...
                                "left" == n ? e.after(o).css("width", "0px") : (e.before(o).css("width", "0px"), o.before(r)),
                                    e.animate({
                                            width: s + "px"
                                        },
                                        animate_time),
            ...
            var e = function() {
                    ...
                    $.contextMenu({
                        ...
                        $("ul.code_theme_list .context-menu-item").mouseenter(function() {
                            Editor.current().setTheme("ace/theme/" + $(this).find("span").html()),
                                $(this).unbind("click").click(function() {
                        ...
                        $("ul.code_mode_list .context-menu-item").mouseenter(function() {
                            Editor.current().getSession().setMode("ace/mode/" + $(this).find("span").html()),
                                $(this).unbind("click").click(function() {
                                    var e = $(this).find("span").html();
                ...
                t = function(e) {
                    ...
                    if (Editor.current()) switch (e) {
                        ...
                        case "auto_complete":
                            ...
                            break;
                        case "function_list":
                            if (auto_function_list && "none" == $(".frame_right .function_list").css("display")) return n.open("function_list"),
                                void 0;
                            auto_function_list ? (auto_function_list = 0, n.close()) : (auto_function_list = 1, n.open("function_list")),
                                Editor.config("function_list", auto_function_list);
                            break;
                        case "open_ie":
                ...
                n = function() {
                    var e = $(".frame_right"),
                        ...
                        i = function(t, i) {
                            ...
                            e.find("." + t).css("display", "block").css("width", s),
                                e.css("display", "block").css("width", "0").stop(!0, !0).animate({
                                        width: s
                                    },
                                    200,
                                    function() {
                ...
                r = function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(e, a, i) {
                            o.close(),
                                _(t.uuid),
                                core.ajaxError(e, a, i)
                        },
                        success: function(e) {
                            if (o.close(), !e.code) return Tips.tips(e),
                                _(t.uuid),
                                void 0;
                            var n = e.data;
                            //console.log(n);
...
//					console.log(e.hasChanged);
                ...
                c = function(e) {
                    ...
                    i.setTheme("ace/theme/" + t.theme),
                        ...
                        i.setDragDelay(100),
                        i.setShowInvisibles(t.display),
                        i.setFontSize(t.fontsize),
                        i.setAnimatedScroll(!0),
                        i.setOptions({
                ...
                u = function(e, i, n) {
                    ...
                    for (var r in s) {
                        ...
                        switch (e) {
                            ...
                            case "theme":
                                t[e] = i,
                                    l.setTheme("ace/theme/" + i),
                                    G.code_config.theme = i,
                                    o = {
                                        k: "theme",
                                        v: i
                                    };
                            ...
                            case "function_list":
                                ...
                                break;
                            case "auto_complete":
                                t[e] = !l.$enableBasicAutocompletion,
                                    l.setOptions({
                    ...
                    if (void 0 != i) {
                        ...
                        if (n.hasChanged) {
                            ...
                            var s = urlEncode2(n.getValue()),
                                o = n.kod.filename;
                            if ("" == o) return tips(LNG.data_error, "warning"),
                                void 0;
                            var r = "./index.php?editor/fileSave";
                            G.share_page !== void 0 && (r = "./index.php?share/fileSave&user=" + G.user + "&sid=" + G.sid + "&filename=" + o),
                                $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                    url: r,
                ...
                x = function() {
                    ...
                    if (e.kod.uuid, "" != t) {
                        ...
                        $.ajax({
                            ...
                            success: function(t) {
                                if (a.close(), !t.code) return Tips.tips(t),
                                    void 0;
                                var i = e.getFirstVisibleRow();
                                e.getSession().setValue(t.data.content),
                                    h(e, !1),
                                    e.scrollToLine(i)
                            }
                        })
    ...
    define("app/common/core", [],
        function(require, exports) {
            return {
                ...
                language: function(e) {
                    Cookie.set("kod_user_language", e, 8760),
                ...
                search: function(e, t) {
                    var a,
                        ...
                        c = function(e) {
                            ...
                            if (!e.search || !e.path) return a.hide().html(LNG.search_info).fadeIn(t),
                                void 0;
                            if (1 >= e.search.length) return a.hide().html("too short!").fadeIn(t),
                                void 0;
                            ...
                            G.share_page !== void 0 && (i = "index.php?share/search&user=" + G.user + "&sid=" + G.sid),
                                $.ajax({
                                    ...
                                    error: core.ajaxError,
                                    success: function(e) {
                                        if (!e.code) return a.hide().html(e.data).fadeIn(t),
                                            void 0;
                                        if (0 == e.data.filelist.length && 0 == e.data.folderlist.length) return a.hide().html(LNG.search_null).fadeIn(t),
                                            void 0;
                                        a.hide();
                ...
                server_dwonload: function(e) {
                    ...
                    var t = $(".download_box"),
                        ...
                        i = t.find("input").val();
                    if (t.find("input").val(""), !i || "http" != i.substr(0, 4)) return core.tips.tips("url false!", !1),
                        void 0;
                    var n = UUID(),
                                ...
                                if (o) {
                                    ...
                                    if (a) {
                                        ...
                                        if (0 == a.length) d.find(".progress-bar").css("width", "100%").text(LNG.loading);
                                            ...
                                            d.find(".progress-bar").css("width", s + "%"),
                                                p.text(parseInt(s) + "%(" + t + ")")
                                        }
